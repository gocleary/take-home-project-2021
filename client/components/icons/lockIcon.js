...
const LockIcon = ({ className, fillColor = 'var(--highlight-color)' }) => (
  <span className={classNames('LockIcon d-inline-block', className)}>
    <svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 24 24' className={className} fill={fillColor}>
      <g data-name='lock'>
